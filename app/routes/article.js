...
import { AddArticle, AddFile, AddIllustration, ArticlePublication, DeleteArticle, GetArticle, UpdateArticle, uploadFile } from "../services/article.js";
...
articleRouter.put('/update', isAdminOrSuperuser, upload.single("image"), UpdateArticle)
