...
import { AddFormation, DeleteFormation, GetFormation, UpdateFormation, upload } from '../services/formation.js'
...
formationRouter.patch('/update', isAdminOrSuperuser, UpdateFormation)
